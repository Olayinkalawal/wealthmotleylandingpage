    ...
    <div className="min-h-screen bg-background">
      <TooltipProvider delayDuration={0}>
        <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-sm border-b">
          <nav className="h-16 flex items-center justify-between px-4 md:px-6 gap-4 max-w-[2000px] mx-auto overflow-hidden">
            <Link href="/" className="flex-shrink-0 h-full flex items-center" prefetch>
              <Image 
                src="/logo.svg" 
                width={256} 
                height={64} 
                className="w-48 md:w-64 h-auto dark:invert-0 invert hover:opacity-75 transition-opacity"
                alt="logo" 
                priority
              />
            </Link>
